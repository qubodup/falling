...
void MoveBirds(){
	...
	BirdArray[0].XPosition = BirdArray[0].XPosition -1;
	BirdArray[1].XPosition = BirdArray[1].XPosition +1;
	BirdArray[2].XPosition = BirdArray[2].XPosition -1;
	BirdArray[3].XPosition = BirdArray[3].XPosition +1;
