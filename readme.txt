...
The state of the game is WIP now. The application is written in C using SDL and SDL_Image. I'm learning C at the moment, so the source code might look like a mess. You can build it with

>
gcc $(sdl-config --cflags --libs) -lSDL_image -o falling main.c clouds.c filehandler.c birds.c player.c lifes.c obstacles.c
>

if you are in the 'falling' directory. A buildsystem is not available at the moment.
