...
The state of the game is 'short playable concept' now. Not sure, if i will put more efforts into it. The application is written in C using SDL and SDL_Image. I'm using this to learn C at the moment, so the source code might look like a mess. You can build it under linux using 'compile.sh', if the folder 'falling' is in your home directory.
