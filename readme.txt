...
The state of the game is WIP now. The application is written in C using SDL and SDL_Image. I'm learning C at the moment, so the source code might look like a mess. You can build it using 'compile.sh', if the folder 'falling' is in your home directory.
